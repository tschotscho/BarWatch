...
public class BarDatabase {
    ...
    public static final String KEY_DAY = "tag";
    ...
    private static final int COLUMN_DAY_INDEX = 4;
    ...
    public long insertFavorite(BarItem fav) {
        ...
        newFavValues.put(KEY_DAY, fav.getDay());
    ...
    public ArrayList<BarItem> getAllToDoItems() {
        ...
        String[] allColumns = new String[]{KEY_ID, KEY_NAME, KEY_TIME, KEY_ANGEBOT, KEY_DAY};
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                favoriten.add(new BarItem(time, fav, angebot, day));
    ...
    public void removeToDoItem(BarItem item) {
    ...
    private class ToDoDBOpenHelper extends SQLiteOpenHelper {
        ...
        private static final String DATABASE_CREATE = "create table "
                ...
                + " text not null, " + KEY_ANGEBOT + " text not null, " + KEY_DAY + " text not null);";
